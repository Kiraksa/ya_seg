...
train_pipeline = [
    ...
    # 2) кроп фиксированного размера
    dict(
        type='RandomCrop',
        crop_size=crop_size,
        cat_max_ratio=0.75      # не брать кропы из чистого фона
    ),
...
class_weight = [0.01100594320933304, 0.2008032128514056, 0.24038461538461536] 
