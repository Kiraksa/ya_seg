...
Мне кажется, что никакой эксперимент не удался. Все случаи показали медианное значение mDice < 0.75. Отдельные примеры показывали 0.9, но другие в то же время 0.3. Разброс слишком велик.
