...
dataset = dict(
    ...
    data_root=
    '/home/kiriy/code/ya_seg/mmsegmentation/data/practicum_dataset_drop',
    img_suffix='.jpg',
    pipeline=[
...
optim_wrapper = dict(
    clip_grad=None,
    optimizer=dict(lr=0.0007, type='AdamW', weight_decay=0.0002),
    type='OptimWrapper')
optimizer = dict(lr=0.0007, type='AdamW', weight_decay=0.0002)
param_scheduler = [
    dict(
...
work_dir = './work_dirs/unet_fcn-256_v5'
